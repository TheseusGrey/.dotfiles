...
snippet("column-breakout", {
  ...
  text({"\t--breakout-size: calc(",
  "\t\t(var(--breakout-max-width) - var(--popout-max-width)) / 2",
  "\t);",
  }),
  text({"", "\t/* Adds in some responsiveness */",
  ...
  text({"", ".content > :not(.popoout, .breakout, .full-width),",
