...
map("v", keymaps.edit("s"), function()
  -- Exit visual mode first so '< '> marks are set
  vim.cmd("normal! " .. vim.api.nvim_replace_termcodes("<Esc>", true, false, true))
  vim.schedule(function()
    require("util.snippet-creator").create_from_selection()
  end)
end, { desc = "Create Snippet from selection" })
map("v", keymaps.edit("S"), function()
  vim.cmd("normal! " .. vim.api.nvim_replace_termcodes("<Esc>", true, false, true))
  vim.schedule(function()
    require("util.snippet-creator").create_from_selection_auto()
  end)
end, { desc = "Create Snippet (auto-tagged)" })
